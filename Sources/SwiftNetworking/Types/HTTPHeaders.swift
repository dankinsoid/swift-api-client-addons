...
public struct HTTPHeaders {
    ...
    /// Creates an instance from a `[HTTPHeaderKey: String]`. Duplicate case-insensitive names are collapsed into the last name
    /// and value encountered.
    public init(_ dictionary: [HTTPHeaderKey: String]) {
    ...
    public init(_ dictionary: [String: String]) {
        dictionary.forEach { update(HTTPHeader(name: HTTPHeaderKey($0.key), value: $0.value)) }
    }
    ...
    public mutating func add(name: HTTPHeaderKey, value: String) {
    ...
    ///   - name:  The `HTTPHeader` name.
    ///   - value: The `HTTPHeader value.
    public mutating func update(name: HTTPHeaderKey, value: String) {
        update(HTTPHeader(name: name, value: value))
    }
    ...
    public mutating func remove(name: HTTPHeaderKey) {
    ...
    public func value(for name: HTTPHeaderKey) -> String? {
    ...
    public subscript(_ name: HTTPHeaderKey) -> String? {
        get { value(for: name) }
        set {
...
extension HTTPHeaders: ExpressibleByDictionaryLiteral {
    ...
    public init(dictionaryLiteral elements: (HTTPHeaderKey, String)...) {
...
public struct HTTPHeader: Hashable {
    ...
    public init(name: HTTPHeaderKey, value: String) {
        self.name = name
        self.value = value
    }
}
...
extension HTTPHeader {
    ...
    public static func contentType(_ value: ContentType) -> HTTPHeader {
        HTTPHeader(name: .contentType, value: value.rawValue)
    }
...
extension [HTTPHeader] {
    ...
    func index(of name: HTTPHeaderKey) -> Int? {
